...
import { getPolicy, updatePolicy } from '../../api/apiHandler';
...
function PrivacyPolicy() {
  ...
  const updpolicy = () => {
    updatePolicy({ "content": policy }).then((response) => {
      if (response.data.code == 1) {
        Swal.fire({
          icon: 'success',
    ...
    <>
      <section className="content">
        <div className="block-header">
          <div className="row">
            <div className="col-lg-7 col-md-6 col-sm-12">
              <h2>Manage Privacy Policy
                <small className="text-muted">View &amp; Edit Privacy Policy</small>
              </h2>
            </div>
        ...
        <CKEditor
                ...
                />
          {/* <ReactQuill placeholder="Type here..." value={policy} onChange={(value) => { setPolicy(value) }} style={{backgroundColor: 'white'}} /> */}
          {/* {policy} */}
          <div className='px-3'>
